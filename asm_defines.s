...
.equ MOVE_ASTRALBARRAGE, 0x2E4  
.equ MOVE_GLACIALLANCE, 0x2E5  
.equ MOVE_EERIESPELL, 0x2E6  
.equ MOVE_ZIPPYZAP,     0x2E7      
.equ MOVE_SAPPYSEED,    0x2E8  
.equ MOVE_FREEZYFROST, 0x2E9  
.equ MOVE_SPARKLYSWIRL, 0x2EA   
.equ MOVE_BOUNCYBUBBLE, 0x2EB   
.equ MOVE_SONICSLASH, 0x2EC        
.equ MOVE_BUZZYBUZZ, 0x2ED        
.equ MOVE_GLITZYGLOW, 0x2EE      
.equ MOVE_SIZZLYSLIDE, 0x2EF       
.equ MOVE_BADDYBAD, 0x2F0         
.equ MOVE_DARKINTENTS, 0x2F1      
.equ MOVE_FIERYDOOM, 0x2F2  
.equ MOVE_SPLISHYSPLASH, 0x2F3  
.equ MOVE_REALITYSHIFT, 0x2F4   
.equ MOVE_STRIPEDDIVE, 0x2F5   
.equ MOVE_PSYSHIELDBASH, 0x2F6  
.equ MOVE_CHLOROBLAST, 0x2F7  
.equ MOVE_HEADLONGRUSH, 0x2F8
.equ MOVE_ESPERWING, x2F9
.equ MOVE_BARBBARRAGE, 0x2FA
.equ MOVE_TRIPLEARROWS, 0x2FB
.equ MOVE_CEASELESSEDGE, 0x2FC
.equ MOVE_INFERNALPARADE, 0x2FD
.equ MOVE_DIRECLAW, 0x2FE
.equ MOVE_BITTERMALICE, 0x2FF
.equ MOVE_RAGINGFURY, 0x300
.equ MOVE_WAVECRASH, 0x301
.equ MOVE_STONEAXE, 0x302
.equ MOVE_SHADOWSTORM, 0x303
.equ MOVE_MOUNTAINGALE, 0x304
.equ MOVE_VICTORYDANCE, 0x305
.equ MOVE_SHELTER, 0x306
.equ MOVE_SPRINGTIDESTORM, 0x307
.equ MOVE_SANDSEARSTORM, 0x308
.equ MOVE_PLACE17, 0x309
.equ MOVE_PLACE18, 0x30A
.equ MOVE_PLACE19, 0x30B
.equ MOVE_PLACE20, 0x30C

.equ MOVE_BREAKNECK_BLITZ_P, 0x30D        
.equ MOVE_BREAKNECK_BLITZ_S, 0x30E          
.equ MOVE_ALL_OUT_PUMMELING_P, 0x30F          
.equ MOVE_ALL_OUT_PUMMELING_S, 0x310          
.equ MOVE_SUPERSONIC_SKYSTRIKE_P, 0x311          
.equ MOVE_SUPERSONIC_SKYSTRIKE_S, 0x312          
.equ MOVE_ACID_DOWNPOUR_P, 0x313   
.equ MOVE_ACID_DOWNPOUR_S, 0x314          
.equ MOVE_TECTONIC_RAGE_P, 0x315          
.equ MOVE_TECTONIC_RAGE_S, 0x316          
.equ MOVE_CONTINENTAL_CRUSH_P, 0x317       
.equ MOVE_CONTINENTAL_CRUSH_S, 0x318          
.equ MOVE_SAVAGE_SPIN_OUT_P, 0x319        
.equ MOVE_SAVAGE_SPIN_OUT_S, 0x31A         
.equ MOVE_NEVER_ENDING_NIGHTMARE_P, 0x31B          
.equ MOVE_NEVER_ENDING_NIGHTMARE_S, 0x31C         
.equ MOVE_CORKSCREW_CRASH_P, 0x31D          
.equ MOVE_CORKSCREW_CRASH_S, 0x31E          
.equ MOVE_INFERNO_OVERDRIVE_P, 0x31F          
.equ MOVE_INFERNO_OVERDRIVE_S, 0x320          
.equ MOVE_HYDRO_VORTEX_P, 0x321         
.equ MOVE_HYDRO_VORTEX_S, 0x322          
.equ MOVE_BLOOM_DOOM_P, 0x323          
.equ MOVE_BLOOM_DOOM_S, 0x324          
.equ MOVE_GIGAVOLT_HAVOC_P, 0x325         
.equ MOVE_GIGAVOLT_HAVOC_S, 0x326         
.equ MOVE_SHATTERED_PSYCHE_P, 0x327          
.equ MOVE_SHATTERED_PSYCHE_S, 0x328         
.equ MOVE_SUBZERO_SLAMMER_P, 0x329        
.equ MOVE_SUBZERO_SLAMMER_S, 0x32A       
.equ MOVE_DEVASTATING_DRAKE_P, 0x32B         
.equ MOVE_DEVASTATING_DRAKE_S, 0x32C        
.equ MOVE_BLACK_HOLE_ECLIPSE_P, 0x32E          
.equ MOVE_BLACK_HOLE_ECLIPSE_S, 0x32F          
.equ MOVE_TWINKLE_TACKLE_P, 0x330          
.equ MOVE_TWINKLE_TACKLE_S, 0x331          

.equ MOVE_CATASTROPIKA, 0x332        
.equ MOVE_10000000_VOLT_THUNDERBOLT, 0x333          
.equ MOVE_STOKED_SPARKSURFER, 0x334          
.equ MOVE_EXTREME_EVOBOOST, 0x335          
.equ MOVE_PULVERIZING_PANCAKE, 0x336          
.equ MOVE_GENESIS_SUPERNOVA, 0x337          
.equ MOVE_SINISTER_ARROW_RAID, 0x338         
.equ MOVE_MALICIOUS_MOONSAULT, 0x339        
.equ MOVE_OCEANIC_OPERETTA, 0x33A	      
.equ MOVE_SPLINTERED_STORMSHARDS, 0x33B          
.equ MOVE_LETS_SNUGGLE_FOREVER, 0x33C          
.equ MOVE_CLANGOROUS_SOULBLAZE, 0x33D          
.equ MOVE_GUARDIAN_OF_ALOLA, 0x33E         
.equ MOVE_SEARING_SUNRAZE_SMASH, 0x33F          
.equ MOVE_MENACING_MOONRAZE_MAELSTROM, 0x340          
.equ MOVE_LIGHT_THAT_BURNS_THE_SKY, 0x341   
.equ MOVE_SOUL_STEALING_7_STAR_STRIKE, 0x342    
...
.equ SPECIES_ENAMORUS_THERIAN, 0x50E
...
.equ ITEM_STAT_CHECKER, 0x2D9
.equ ITEM_POCKET_CENTRE, 0x2DA
.equ ITEM_POCKET_PC, 0x2DB
.equ ITEM_ABILITY_PATCH, 0x2DC
.equ ITEM_CATCHING_CHARM, 0x2DD
.equ ITEM_REINS_OF_UNITY, 0x2DE
.equ ITEM_ZYGARDE_CUBE, 0x2DF
.equ ITEM_BLACK_AUGURITE, 0x2E0
...
.equ EFFECT_SPEED_DOWN_RECOIL, 216
.equ EFFECT_FOCUS_ENERGY_HIT, 217
