...
.equ MOVE_BREAKNECK_BLITZ_P, 0x2C9
.equ MOVE_BREAKNECK_BLITZ_S, 0x2CA
.equ MOVE_ALL_OUT_PUMMELING_P, 0x2CB
.equ MOVE_ALL_OUT_PUMMELING_S, 0x2CC
.equ MOVE_SUPERSONIC_SKYSTRIKE_P, 0x2CD
.equ MOVE_SUPERSONIC_SKYSTRIKE_S, 0x2CE
.equ MOVE_ACID_DOWNPOUR_P, 0x2CF
.equ MOVE_ACID_DOWNPOUR_S, 0x2D0
.equ MOVE_TECTONIC_RAGE_P, 0x2D1
.equ MOVE_TECTONIC_RAGE_S, 0x2D2
.equ MOVE_CONTINENTAL_CRUSH_P, 0x2D3
.equ MOVE_CONTINENTAL_CRUSH_S, 0x2D4
.equ MOVE_SAVAGE_SPIN_OUT_P, 0x2D5
.equ MOVE_SAVAGE_SPIN_OUT_S, 0x2D6
.equ MOVE_NEVER_ENDING_NIGHTMARE_P, 0x2D7
.equ MOVE_NEVER_ENDING_NIGHTMARE_S, 0x2D8
.equ MOVE_CORKSCREW_CRASH_P, 0x2D9
.equ MOVE_CORKSCREW_CRASH_S, 0x2DA
.equ MOVE_INFERNO_OVERDRIVE_P, 0x2DB
.equ MOVE_INFERNO_OVERDRIVE_S, 0x2DC
.equ MOVE_HYDRO_VORTEX_P, 0x2DD
.equ MOVE_HYDRO_VORTEX_S, 0x2DE
.equ MOVE_BLOOM_DOOM_P, 0x2DF
.equ MOVE_BLOOM_DOOM_S, 0x2E0
.equ MOVE_GIGAVOLT_HAVOC_P, 0x2E1
.equ MOVE_GIGAVOLT_HAVOC_S, 0x2E2
.equ MOVE_SHATTERED_PSYCHE_P, 0x2E3
.equ MOVE_SHATTERED_PSYCHE_S, 0x2E4
.equ MOVE_SUBZERO_SLAMMER_P, 0x2E5
.equ MOVE_SUBZERO_SLAMMER_S, 0x2E6
.equ MOVE_DEVASTATING_DRAKE_P, 0x2E7
.equ MOVE_DEVASTATING_DRAKE_S, 0x2E8
.equ MOVE_BLACK_HOLE_ECLIPSE_P, 0x2E9
.equ MOVE_BLACK_HOLE_ECLIPSE_S, 0x2EA
.equ MOVE_TWINKLE_TACKLE_P, 0x2EB
.equ MOVE_TWINKLE_TACKLE_S, 0x2EC
.equ MOVE_CATASTROPIKA, 0x2ED
.equ MOVE_10000000_VOLT_THUNDERBOLT, 0x2EE
.equ MOVE_STOKED_SPARKSURFER, 0x2EF
.equ MOVE_EXTREME_EVOBOOST, 0x2F0
.equ MOVE_PULVERIZING_PANCAKE, 0x2F1
.equ MOVE_GENESIS_SUPERNOVA, 0x2F2
.equ MOVE_SINISTER_ARROW_RAID, 0x2F3
.equ MOVE_MALICIOUS_MOONSAULT, 0x2F4
.equ MOVE_OCEANIC_OPERETTA, 0x2F5
.equ MOVE_SPLINTERED_STORMSHARDS, 0x2F6
.equ MOVE_LETS_SNUGGLE_FOREVER, 0x2F7
.equ MOVE_CLANGOROUS_SOULBLAZE, 0x2F8
.equ MOVE_GUARDIAN_OF_ALOLA, 0x2F9
.equ MOVE_SEARING_SUNRAZE_SMASH, 0x2FA
.equ MOVE_MENACING_MOONRAZE_MAELSTROM, 0x2FB
.equ MOVE_LIGHT_THAT_BURNS_THE_SKY, 0x2FC
.equ MOVE_SOUL_STEALING_7_STAR_STRIKE, 0x2FD

.equ MOVE_MAX_GUARD, 0x2FE
.equ MOVE_MAX_FLARE, 0x2FF
.equ MOVE_MAX_FLUTTERBY, 0x300
.equ MOVE_MAX_LIGHTNING, 0x301
.equ MOVE_MAX_STRIKE, 0x302
.equ MOVE_MAX_KNUCKLE, 0x303
.equ MOVE_MAX_PHANTASM, 0x304
.equ MOVE_MAX_HAILSTORM, 0x305
.equ MOVE_MAX_OOZE, 0x306
.equ MOVE_MAX_GEYSER, 0x307
.equ MOVE_MAX_AIRSTREAM, 0x308
.equ MOVE_MAX_STARFALL, 0x309
.equ MOVE_MAX_WYRMWIND, 0x30A
.equ MOVE_MAX_MINDSTORM, 0x30B
.equ MOVE_MAX_ROCKFALL, 0x30C
.equ MOVE_MAX_QUAKE, 0x30D
.equ MOVE_MAX_DARKNESS, 0x30E
.equ MOVE_MAX_OVERGROWTH, 0x30F
.equ MOVE_MAX_STEELSPIKE, 0x310
.equ MOVE_G_MAX_WILDFIRE, 0x311
.equ MOVE_G_MAX_BEFUDDLE, 0x312
.equ MOVE_G_MAX_VOLTCRASH, 0x313
.equ MOVE_G_MAX_GOLDRUSH, 0x314
.equ MOVE_G_MAX_CHISTRIKE, 0x315
.equ MOVE_G_MAX_TERROR, 0x316
.equ MOVE_G_MAX_RESONANCE, 0x317
.equ MOVE_G_MAX_CUDDLE, 0x318
.equ MOVE_G_MAX_REPLENISH, 0x319
.equ MOVE_G_MAX_MALODOR, 0x31A
.equ MOVE_G_MAX_STONESURGE, 0x31B
.equ MOVE_G_MAX_WINDRAGE, 0x31C
.equ MOVE_G_MAX_STUNSHOCK, 0x31D
.equ MOVE_G_MAX_FINALE, 0x31E
.equ MOVE_G_MAX_DEPLETION, 0x31F
.equ MOVE_G_MAX_GRAVITAS, 0x320
.equ MOVE_G_MAX_VOLCALITH, 0x321
.equ MOVE_G_MAX_SANDBLAST, 0x322
.equ MOVE_G_MAX_SNOOZE, 0x323
.equ MOVE_G_MAX_TARTNESS, 0x324
.equ MOVE_G_MAX_SWEETNESS, 0x325
.equ MOVE_G_MAX_SMITE, 0x326
.equ MOVE_G_MAX_STEELSURGE, 0x327
.equ MOVE_G_MAX_MELTDOWN, 0x328
.equ MOVE_G_MAX_FOAMBURST, 0x329
.equ MOVE_G_MAX_CENTIFERNO, 0x32A
