...
//Z-Moves
.equ MOVE_BREAKNECK_BLITZ_P, 0x2E7
.equ MOVE_BREAKNECK_BLITZ_S, 0x2E8
.equ MOVE_ALL_OUT_PUMMELING_P, 0x2E9
.equ MOVE_ALL_OUT_PUMMELING_S, 0x2EA
.equ MOVE_SUPERSONIC_SKYSTRIKE_P, 0x2EB
.equ MOVE_SUPERSONIC_SKYSTRIKE_S, 0x2EC
.equ MOVE_ACID_DOWNPOUR_P, 0x2ED
.equ MOVE_ACID_DOWNPOUR_S, 0x2EE
.equ MOVE_TECTONIC_RAGE_P, 0x2EF
.equ MOVE_TECTONIC_RAGE_S, 0x2F0
.equ MOVE_CONTINENTAL_CRUSH_P, 0x2F1
.equ MOVE_CONTINENTAL_CRUSH_S, 0x2F2
.equ MOVE_SAVAGE_SPIN_OUT_P, 0x2F3
.equ MOVE_SAVAGE_SPIN_OUT_S, 0x2F4
.equ MOVE_NEVER_ENDING_NIGHTMARE_P, 0x2F5
.equ MOVE_NEVER_ENDING_NIGHTMARE_S, 0x2F6
.equ MOVE_CORKSCREW_CRASH_P, 0x2F7
.equ MOVE_CORKSCREW_CRASH_S, 0x2F8
.equ MOVE_INFERNO_OVERDRIVE_P, 0x2F9
.equ MOVE_INFERNO_OVERDRIVE_S, 0x2FA
.equ MOVE_HYDRO_VORTEX_P, 0x2FB
.equ MOVE_HYDRO_VORTEX_S, 0x2FC
.equ MOVE_BLOOM_DOOM_P, 0x2FD
.equ MOVE_BLOOM_DOOM_S, 0x2FE
.equ MOVE_GIGAVOLT_HAVOC_P, 0x2FF
.equ MOVE_GIGAVOLT_HAVOC_S, 0x300
.equ MOVE_SHATTERED_PSYCHE_P, 0x301
.equ MOVE_SHATTERED_PSYCHE_S, 0x302
.equ MOVE_SUBZERO_SLAMMER_P, 0x303
.equ MOVE_SUBZERO_SLAMMER_S, 0x304
.equ MOVE_DEVASTATING_DRAKE_P, 0x305
.equ MOVE_DEVASTATING_DRAKE_S, 0x306
.equ MOVE_BLACK_HOLE_ECLIPSE_P, 0x307
.equ MOVE_BLACK_HOLE_ECLIPSE_S, 0x308
.equ MOVE_TWINKLE_TACKLE_P, 0x309
.equ MOVE_TWINKLE_TACKLE_S, 0x30A

.equ MOVE_CATASTROPIKA, 0x30B
.equ MOVE_10000000_VOLT_THUNDERBOLT, 0x30C
.equ MOVE_STOKED_SPARKSURFER, 0x30D			//Paralyze Target
.equ MOVE_EXTREME_EVOBOOST, 0x30E				//Double Ancient Power
.equ MOVE_PULVERIZING_PANCAKE, 0x30F
.equ MOVE_GENESIS_SUPERNOVA, 0x310			//Sets up Psychic Terrain
.equ MOVE_SINISTER_ARROW_RAID, 0x311
.equ MOVE_MALICIOUS_MOONSAULT, 0x312
.equ MOVE_OCEANIC_OPERETTA, 0x313
.equ MOVE_SPLINTERED_STORMSHARDS, 0x314		//Removes Terrain
.equ MOVE_LETS_SNUGGLE_FOREVER, 0x315
.equ MOVE_CLANGOROUS_SOULBLAZE, 0x316			//Ancient Power
.equ MOVE_GUARDIAN_OF_ALOLA, 0x317
.equ MOVE_SEARING_SUNRAZE_SMASH, 0x318
.equ MOVE_MENACING_MOONRAZE_MAELSTROM, 0x319
.equ MOVE_LIGHT_THAT_BURNS_THE_SKY, 0x31A
.equ MOVE_SOUL_STEALING_7_STAR_STRIKE, 0x31B
