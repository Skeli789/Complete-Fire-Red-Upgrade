...
.equ BANNED_POKEDEX_FLAGS_BATTLE_TYPES, BATTLE_WIRELESS | BATTLE_OLD_MAN | BATTLE_E_READER | BATTLE_POKE_DUDE | BATTLE_GHOST | BATTLE_TRAINER_TOWER | BATTLE_FRONTIER
