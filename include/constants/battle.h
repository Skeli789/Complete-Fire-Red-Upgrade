...
#define BATTLE_TYPE_FRONTIER            (BATTLE_TYPE_BATTLE_TOWER)
...
#define STATUS3_SEMI_INVULNERABLE       (STATUS3_UNDERGROUND | STATUS3_IN_AIR | STATUS3_UNDERWATER |  STATUS3_DISAPPEARED)
...
#define MOVE_EFFECT_RECOIL_50          	0x37
...
#define MOVE_EFFECT_THROAT_CHOP         0x3D
#define MOVE_EFFECT_RESET_STAT_CHANGES  0x3E
#define MOVE_EFFECT_LIFT_PROTECT        0x3F
...
/*#define MOVE_EFFECT_ATK_PLUS_3
#define MOVE_EFFECT_DEF_PLUS_3
#define MOVE_EFFECT_SPD_PLUS_3
#define MOVE_EFFECT_SP_ATK_PLUS_3
#define MOVE_EFFECT_SP_DEF_PLUS_3
#define MOVE_EFFECT_ACC_PLUS_3
#define MOVE_EFFECT_EVS_PLUS_3
#define MOVE_EFFECT_ATK_MINUS_3
#define MOVE_EFFECT_DEF_MINUS_3
#define MOVE_EFFECT_SPD_MINUS_3
#define MOVE_EFFECT_SP_ATK_MINUS_3
#define MOVE_EFFECT_SP_DEF_MINUS_3
#define MOVE_EFFECT_ACC_MINUS_3
#define MOVE_EFFECT_EVS_MINUS_3

#define MOVE_EFFECT_REMOVE_SLEEP
#define MOVE_EFFECT_REMOVE_BURN
#define MOVE_EFFECT_RECOIL_50
#define MOVE_EFFECT_BURN_BERRY
#define MOVE_EFFECT_EAT_BERRY
#define MOVE_EFFECT_BRING_DOWN
#define MOVE_EFFECT_RELIC_SONG
#define MOVE_EFFECT_ION_DELUGE
#define MOVE_EFFECT_THROAT_CHOP
#define MOVE_EFFECT_FLAME_BURST
#define MOVE_EFFECT_RESET_STAT_CHANGES
#define MOVE_EFFECT_LIFT_PROTECT
#define MOVE_EFFECT_SUPPRESS_ABILITY
#define MOVE_EFFECT_BREAK_SCREENS
#define MOVE_EFFECT_SET_PSYCHIC_TERRAIN
#define MOVE_EFFECT_REMOVE_TERRAIN
#define MOVE_EFFECT_BURN_UP
*/
