...
#define BATTLE_TYPE_BATTLE_MINE			0x4000000
#define BATTLE_TYPE_BATTLE_CIRCUS		0x8000000
#define BATTLE_TYPE_CAMOMONS			0x10000000
#define BATTLE_TYPE_SCALEMONS			0x20000000

#define BATTLE_TYPE_SHADOW_WARRIOR		0x80000000 //Used in Pokemon Unbound
#define BATTLE_TYPE_FRONTIER            (BATTLE_TYPE_BATTLE_TOWER | BATTLE_TYPE_BATTLE_SANDS | BATTLE_TYPE_BATTLE_MINE | BATTLE_TYPE_BATTLE_CIRCUS)
