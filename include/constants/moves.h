...
#define MOVE_MAX_FLARE 0x2FF
#define MOVE_MAX_FLUTTERBY 0x300
#define MOVE_MAX_LIGHTNING 0x301
#define MOVE_MAX_STRIKE 0x302
#define MOVE_MAX_KNUCKLE 0x303
#define MOVE_MAX_PHANTASM 0x304
#define MOVE_MAX_HAILSTORM 0x305
#define MOVE_MAX_OOZE 0x306
#define MOVE_MAX_GEYSER 0x307
#define MOVE_MAX_AIRSTREAM 0x308
#define MOVE_MAX_STARFALL 0x309
#define MOVE_MAX_WYRMWIND 0x30A
#define MOVE_MAX_MINDSTORM 0x30B
#define MOVE_MAX_ROCKFALL 0x30C
#define MOVE_MAX_QUAKE 0x30D
#define MOVE_MAX_DARKNESS 0x30E
#define MOVE_MAX_OVERGROWTH 0x30F
#define MOVE_MAX_STEELSPIKE 0x310
#define MOVE_G_MAX_WILDFIRE 0x311
#define MOVE_G_MAX_BEFUDDLE 0x312
#define MOVE_G_MAX_VOLTCRASH 0x313
#define MOVE_G_MAX_GOLDRUSH 0x314
#define MOVE_G_MAX_CHISTRIKE 0x315
#define MOVE_G_MAX_TERROR 0x316
#define MOVE_G_MAX_RESONANCE 0x317
#define MOVE_G_MAX_CUDDLE 0x318
#define MOVE_G_MAX_REPLENISH 0x319
#define MOVE_G_MAX_MALODOR 0x31A
#define MOVE_G_MAX_STONESURGE 0x31B
#define MOVE_G_MAX_WINDRAGE 0x31C
#define MOVE_G_MAX_STUNSHOCK 0x31D
#define MOVE_G_MAX_FINALE 0x31E
#define MOVE_G_MAX_DEPLETION 0x31F
#define MOVE_G_MAX_GRAVITAS 0x320
#define MOVE_G_MAX_VOLCALITH 0x321
#define MOVE_G_MAX_SANDBLAST 0x322
#define MOVE_G_MAX_SNOOZE 0x323
#define MOVE_G_MAX_TARTNESS 0x324
#define MOVE_G_MAX_SWEETNESS 0x325
#define MOVE_G_MAX_SMITE 0x326
#define MOVE_G_MAX_STEELSURGE 0x327
#define MOVE_G_MAX_MELTDOWN 0x328
#define MOVE_G_MAX_FOAMBURST 0x329
#define MOVE_G_MAX_CENTIFERNO 0x32A

#define FIRST_MAX_MOVE      MOVE_MAX_GUARD
#define LAST_MAX_MOVE       MOVE_MAX_STEELSPIKE
#define FIRST_G_MAX_MOVE    MOVE_G_MAX_WILDFIRE
#define LAST_G_MAX_MOVE     MOVE_G_MAX_CENTIFERNO

#define LAST_MOVE_INDEX     MOVE_G_MAX_CENTIFERNO
#define MOVES_COUNT        (MOVE_G_MAX_CENTIFERNO + 1)
