...
//GEN 9 MOVES LOSERS // edit the hex values
#define MOVE_AQUACUTTER 0x2E4
#define MOVE_AQUASTEP 0x2E5
#define MOVE_ARMORCANNON 0x2E6
#define MOVE_AXEKICK 0x2E7
#define MOVE_BITTERBLADE 0x2E8
#define MOVE_BLAZINGTORGUE 0x2E9
#define MOVE_CHILLINGWATER 0x2F1
#define MOVE_CHILLYRECEPTION 0x2F2
#define MOVE_COLLISIONCOURSE 0x2F3
#define MOVE_COMBATTORGUE 0x2F4
#define MOVE_COMEUPPANCE 0x2F5
#define MOVE_DOODLE 0x2F6
#define MOVE_DOUBLESHOCK 0x2F7
#define MOVE_ELECTROSHIFT 0x2F8
#define MOVE_FILLETWAY 0x2F9
#define MOVE_FLOWERTRICK 0x2FA
#define MOVE_GIGATONHAMMER 0x300
#define MOVE_GLAVIERUSH 0x301
#define MOVE_HYDROSTEAM 0x302
#define MOVE_HYPERDRILL 0x303
#define MOVE_ICESPINNER 0x304
#define MOVE_JETPUNCH 0x305
#define MOVE_KOWTOWCLEAVE 0x306
#define MOVE_LASTRESPECTS 0x307
#define MOVE_LUMINACRASH 0x308
#define MOVE_MAGICALTORGUE 0x309
#define MOVE_MAKEITRAIN 0x3A1
#define MOVE_MORTALSPIN 0x3A2
#define MOVE_NOXIOUSTORGUE 0x3A3
#define MOVE_ORDERUP 0x3A4
#define MOVE_POPULATIONBOMB 0x3A5
#define MOVE_POUNCE 0x3A6
#define MOVE_PSYBLADE 0x3A7
#define MOVE_RAGEFIST 0x3A8
#define MOVE_RAGINGBULL 0x3A9
#define MOVE_REVIVALBLESSING 0x3B1
#define MOVE_RUINNATION 0x3B2
#define MOVE_SALTCURE 0x3B3
#define MOVE_SHEDTAIL 0x3B4
#define MOVE_SILKTRAP 0x3B5
#define MOVE_SNOWSCAPE 0x3B6
#define MOVE_SPICYEXTRACT 0x3B7
#define MOVE_SPINOUT 0x3B8
#define MOVE_TERABLAST 0x3B9
#define MOVE_TIDYUP 0x3C1
#define MOVE_TORCHSONG 0x3C2
#define MOVE_TRAILBLAZE 0x3C3
#define MOVE_TRIPLEDIVE 0x3C4
#define MOVE_TWINBEAM 0x3C5
#define MOVE_WICKEDTORGUE 0x3C6
