...
#define EFFECT_DEFENSE_UP_2 51 //+ Cotton Guard
...
#define EFFECT_MEAN_LOOK 106 //+ Anchor Shot + Spirit Shackle + Thousand Waves
...
#define EFFECT_EXTERME_EVOBOOST 207
