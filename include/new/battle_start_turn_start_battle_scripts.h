...
extern u8 BattleScript_CamomonsTypeRevealEnd3[];
extern u8 BattleScript_CamomonsTypeRevealRet[];

extern u8 gText_CamomonsTypeReveal[];
extern u8 gText_CamomonsTypeRevealDualType[];