...
#define	STRINGID_ELECTRICTERRAINACTIVATEDABILITY	381
#define STRINGID_STATWASHEIGHTENED 382
#define STRINGID_SUNLIGHTACTIVATEDABILITY 383

#define STRINGID_CUSTOMSTRING		388
