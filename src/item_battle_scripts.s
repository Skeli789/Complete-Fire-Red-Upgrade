...
WP_Atk:
	...
	playstatchangeanimation BANK_ATTACKER STAT_ANIM_ATK | STAT_ANIM_SPATK  STAT_ANIM_UP | STAT_ANIM_CAN_FAIL
...
BattleScript_EjectButton:
	jumpifcannotswitch 0xA @EjectButtonEnd
	playanimation 0xA ANIM_ITEM_USE 0x0
	setword BATTLE_STRING_LOADER EjectButtonString
	printstring 0x184
	waitmessage DELAY_1SECOND
	removeitem 0xA
	playanimation 0xA ANIM_CALL_BACK_POKEMON 0x0
	waitanimation
	openpartyscreen 0xA EjectButtonEnd
	switchoutabilities 0xA
	waitstateatk
	switchhandleorder 0xA 0x2
	returntoball 0xA
	switch1 0xA
	switch2 0xA
	hpthresholds 0xA
...
.align 2
CheekPouchString: .byte 0xFD, 0x13, 0xB4, 0xE7, 0x00, 0xFD, 0x1A, 0xFE, 0xE6, 0xD9, 0xE7, 0xE8, 0xE3, 0xE6, 0xD9, 0xD8, 0x00, 0xDD, 0xE8, 0xE7, 0x00, 0xC2, 0xCA, 0xAB, 0xFF
...
EjectButtonString: .byte 0xFD, 0x10, 0x00, 0xDD, 0xE7, 0x00, 0xE7, 0xEB, 0xDD, 0xE8, 0xD7, 0xDC, 0xD9, 0xD8, 0xFE, 0xE3, 0xE9, 0xE8, 0x00, 0xEB, 0xDD, 0xE8, 0xDC, 0x00, 0xE8, 0xDC, 0xD9, 0x00, 0xFD, 0x16, 0xAB, 0xFF
RedCardString: .byte 0xFD, 0x10, 0x00, 0xDC, 0xD9, 0xE0, 0xD8, 0x00, 0xE9, 0xE4, 0x00, 0xDD, 0xE8, 0xE7, 0xFE, 0xFD, 0x16, 0x00, 0xD5, 0xDB, 0xD5, 0xDD, 0xE2, 0xE7, 0xE8, 0x00, 0xFD, 0x0F, 0xAB, 0xFF
