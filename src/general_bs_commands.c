...
//Move Stomping Tantrum to end command based on gNewBS->TargetsHit
...
//Update this!
#define BattleScript_NoHealTargetAfterHealBlock (u8*) 0x81D694E //extern u8 BattleScript_NoHealTargetAfterHealBlock[];
