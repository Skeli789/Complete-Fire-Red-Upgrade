...
BS_118_Swagger:
	...
	setgraphicalstatchangevalues
	playanimation BANK_TARGET, B_ANIM_STATS_CHANGE, ANIM_ARG_1
	printfromtable 0x83FE57C
	waitmessage DELAY_1SECOND
...
BS_160_Stockpile:
	...
	waitmessage DELAY_1SECOND
	jumpifstatcanberaised BANK_TARGET STAT_DEF StockpileRaiseDef
	jumpifstatcanberaised BANK_TARGET STAT_SPDEF StockpileRaiseDef
...
BS_168_Memento:
	attackcanceler
	jumpifhalfword EQUALS CURRENTMOVE MOVE_FINALGAMBIT FinalGambitBS
	jumpifhalfword EQUALS CURRENTMOVE MOVE_MEMENTO 0x81D7FA0
...
FinalGambitBS:
	...
	seteffectwithchancetarget
	faintpokemon BANK_TARGET 0x0 0x0
	jumpifbyte ANDS OUTCOME OUTCOME_NO_EFFECT BS_MOVE_END
	setuserhptozero
	graphicalhpupdate BANK_ATTACKER
	datahpupdate BANK_ATTACKER
	faintpokemon BANK_ATTACKER 0x0 0x0
...
BS_171_SmellingSalt:
	...
	jumpifmove MOVE_WAKEUPSLAP WakeUpSlapBS
	jumpifmove MOVE_SPARKLINGARIA SparklingAriaBS
...
WakeUpSlapBS:
	...
	jumpifmovehadnoeffect BS_MOVE_END
	jumpifstatus BANK_TARGET STATUS_SLEEP WakeUpTargetBS
	goto BS_MOVE_END
...
SparklingAriaBS:
	...
	jumpiffainted BANK_TARGET BS_MOVE_END
	jumpifmovehadnoeffect BS_MOVE_END
	jumpifstatus BANK_TARGET STATUS_BURN CureBurnTargetBS
	goto BS_MOVE_END
...
RecycleBS:
	attackstring
	ppreduce
	jumpifcounter BANK_ATTACKER INCINERATE_COUNTER NOTEQUALS 0x0 FAILED
	recycleitem FAILED
	attackanimation
	waitanimation
	printstring 0x140
...
BS_186_BrickBreak:
	setmoveeffect MOVE_EFFECT_REMOVE_SCREENS
...
.global BS_202_BadPoisonChance
BS_202_BadPoisonChance:
...
BS_222_DamageResetTargetStatChanges:
	setmoveeffect MOVE_EFFECT_RESET_STATS_TARGET
	goto 0x81D6926
...
TransformToPirouetteBS:
	formchange BANK_ATTACKER PKMN_MELOETTA PKMN_MELOETTA_PIROUETTE TRUE BS_MOVE_END
	goto MeloettaTransformAnim

TransformToAriaBS:
	formchange BANK_ATTACKER PKMN_MELOETTA_PIROUETTE PKMN_MELOETTA TRUE BS_MOVE_END
...
BS_231_AttackBlockers:
	attackcanceler
	jumpifmove MOVE_THROAT_CHOP ThroatChopBS
...
BS_233_HealTarget:
	attackcanceler
	jumpifhalfword EQUALS CURRENTMOVE MOVE_POLLENPUFF PollenPuffBS

HealPulseBS:
	attackstring
	ppreduce
	jumpifbehindsubstitute BANK_TARGET FAILED
	jumpifcounter BANK_TARGET HEAL_BLOCK_TIMERS NOTEQUALS 0x0 NoHealingTarget
	accuracycheck BS_MOVE_MISSED+2 0x0
...
.global BS_235_FairyLockHappyHour
BS_236_FairyLockHappyHour:
	attackcanceler
	attackstring
	ppreduce
