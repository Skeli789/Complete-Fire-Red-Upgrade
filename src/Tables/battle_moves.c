...
const struct BattleMove gBattleMoves[] =
{
	...
	[MOVE_AQUASTEP] =
	{
		...
		[MOVE_ARMORCANNON] =
	{
		.effect = EFFECT_DEFENSE_DOWN, EFFECT_SPECIAL_DEFENSE_DOWN,
		.power = 120,
		.type = TYPE_FIRE,
		.accuracy = 100,
		.pp = 4,
		...
		[MOVE_AXEKICK] =
	{
		.effect = EFFECT_CONFUSE_HIT, EFFECT_RECOIL_IF_MISS,
		.power = 120,
		.type = TYPE_FIGHTING,
		.accuracy = 90,
		.pp = 10,
	...
	{
		.effect = EFFECT_BATON_PASS, EFFECT_HAIL,
		.power = 0,
		.type = TYPE_ICE,
		.accuracy = 100,
		.pp = 10,
		...
		[MOVE_COMBATTORGUE] =
	{
		...
		[MOVE_COMEUPPANCE] =
	{
		.effect = EFFECT_HIT, // Deals more damage to the opponent that last inflicted damage on it. (MAKE THAT A EFFECT WEIRDOS)
		.power = 100,
		.type = TYPE_DARK,
		.accuracy = 100,
		.pp = 10,
		...
		[MOVE_DOODLE] =
	{
		.effect = EFFECT_SKILL_SWAP, EFFECT_TEAM_EFFECTS,
		.power = 0,
		.type = TYPE_NORMAL,
		.accuracy = 100,
		.pp = 10,
		...
		[MOVE_DOUBLESHOCK] =
	{
		.effect = EFFECT_HIT, // need a new effect
		.power = 120,
		.type = TYPE_ELECTRIC,
		.accuracy = 100,
		.pp = 10,
		...
		[MOVE_ELECTROSHIFT] = // not fixing the name needs effect as well
	{
		.effect = EFFECT_HIT,
		.power = 100,
		.type = TYPE_ELECTRIC,
		...
		[MOVE_FILLETWAY] =
	{
		...
		[MOVE_FLOWERTRICK] =
	{
		.effect = EFFECT_ALWAYS_HIT, EFFECT_HIGH_CRITICAL,
		.power = 70,
		.type = TYPE_GRASS,
		.accuracy = 0,
		.pp = 10,
		...
		[MOVE_GIGATONHAMMER] =
	{
		...
		[MOVE_GLAVIERUSH] =
	{
		.effect = EFFECT_DOUBLE_HIT, // need new effects
		.power = 120,
		.type = TYPE_DRAGON,
		.accuracy = 100,
		.pp = 5,
		...
		[MOVE_HYDROSTEAM] =
	{
		.effect = EFFECT_BURN_HIT, // need effect
		.power = 80,
		.type = TYPE_WATER,
		.accuracy = 100,
		.pp = 15,
		...
		[MOVE_HYPERDRILL] =
	{
		...
		[MOVE_ICESPINNER] =
	{
		.effect = MOVE_EFFECT_REMOVE_TERRAIN,
		.power = 80,
		.type = TYPE_ICE,
		.accuracy = 100,
		.pp = 15,
		...
		[MOVE_KOWTOWCLEAVE] =
	{
		...
		[MOVE_LASTRESPECTS] =
	{
		.effect = EFFECT_BEAT_UP, // NEED EFFECT
		.power = 50,
		.type = TYPE_GHOST,
		.accuracy = 100,
		.pp = 10,
		...
		[MOVE_MAGICALTORGUE] =
	{
		...
		[MOVE_MAKEITRAIN] =
	{
		.effect = EFFECT_SPECIAL_ATTACK_DOWN_2, EFFECT_PAY_DAY,
		.power = 120,
		.type = TYPE_STEEL,
		.accuracy = 100,
		.pp = 5,
		...
		[MOVE_MORTALSPIN] =
	{
		.effect = EFFECT_RAPID_SPIN, EFFECT_TOXIC,
		.power = 30,
		.type = TYPE_POISON,
		.accuracy = 100,
		.pp = 15,
		...
		[MOVE_ORDERUP] =
	{
		...
		.z_move_effect = 0
			...
			[MOVE_POPULATIONBOMB] = // CUSTOM EFFECT???
	{
		.effect = EFFECT_MULTI_HIT,
		.power = 20,
		.type = TYPE_NORMAL,
			...
			[MOVE_POUNCE] =
	{
		...
		.z_move_effect = 0
			...
			[MOVE_PSYBLADE] =
	{
		.effect = EFFECT_HIT, // needs custom effect
		.power = 80,
		.type = TYPE_PSYCHIC,
		.accuracy = 100,
		.pp = 15,
		...
		.z_move_effect = 0
			...
			[MOVE_RAGEFIST] =
	{
		.effect = EFFECT_HIT, EFFECT_MULTI_HIT, // NEEDS CUSTOM EFFECT
		.power = 50,
		.type = TYPE_GHOST,
		.accuracy = 100,
		.pp = 10,
		...
		.z_move_effect = 0
			...
			[MOVE_REVIVALBLESSING] = // NEED CUSTOM EFFECT
	{
		.effect = EFFECT_HEAL_BELL,
		.power = 0,
		.type = TYPE_NORMAL,
			...
			[MOVE_SALTCURE] = // NEEDS EFFECT
	{
		...
		.z_move_effect = 0
			...
			[MOVE_SHEDTAIL] =
	{
		.effect = EFFECT_SUBSTITUTE, EFFECT_BATON_PASS,
		.power = 0,
		.type = TYPE_NORMAL,
		.accuracy = 100,
		.pp = 10,
		...
		.z_move_effect = 0
			...
			[MOVE_SILKTRAP] =
	{
		.effect = EFFECT_PROTECT, EFFECT_SPEED_DOWN_HIT,
		.power = 0,
		.type = TYPE_BUG,
		.accuracy = 100,
		.pp = 10,
			...
			[MOVE_SNOWSCAPE] =
	{
		...
		.z_move_effect = 0
			...
			[MOVE_SPICYEXTRACT] =
	{
		.effect = EFFECT_DEFENSE_DOWN_2, EFFECT_ATTACK_UP_2,
		.power = 0,
		.type = TYPE_GRASS,
		.accuracy = 0,
		.pp = 10,
				...
				[MOVE_SPINOUT] =
	{
		...
		.z_move_effect = 0
				...
				[MOVE_TERABLAST] =
	{
		.effect = EFFECT_CONVERSION, //NEEDS EFFECT TERRA BASED TYPE CHANGE
		.power = 80,
		.type = TYPE_NORMAL,
		.accuracy = 0,
		.pp = 10,
		...
		.z_move_effect = 0
				...
				[MOVE_TIDYUP] =
	{
		.effect = EFFECT_RAPID_SPIN, EFFECT_DRAGON_DANCE,
		.power = 0,
		.type = TYPE_NORMAL,
		.accuracy = 0,
		.pp = 10,
