...
const struct BattleMove gBattleMoves[] =
{
	...
	[MOVE_SHELLSIDEARM] =
	{	//ANIM TODO
		.effect = EFFECT_SHELLSIDEARM, //EFFECT TODO
		.power = 90,
		.type = TYPE_POISON,
		.accuracy = 100,
		.pp = 10,
...
const u8 gDynamaxMovePowers[MOVES_COUNT] =
{
	...
	[MOVE_BUZZYBUZZ] = 130,
	[MOVE_GLITZYGLOW] = 130,
	[MOVE_SIZZLYSLIDE] = 130,
	[MOVE_BADDYBAD] = 130,
	[MOVE_DARKINTENTS] = 140,
	[MOVE_FIERYDOOM] = 130,
	[MOVE_SPLISHYSPLASH] = 130,
	[MOVE_REALITYSHIFT] = 150,
	[MOVE_STRIPEDDIVE] = 130,
	[MOVE_PSYSHIELDBASH] = 130,
