...
const u16 gClassBasedTrainerEncounterBGM[NUM_TRAINER_CLASSES] =
{
	...
	[CLASS_SPECIES_PROF] = BGM_EYE_BOY,
	[CLASS_PLAYER] = BGM_EYE_BOY,
	[CLASS_CRUSH_GIRL] =  BGM_EYE_GIRL,
	[CLASS_TUBER] = BGM_EYE_BOY,
	[CLASS_SPECIES_BREEDER] = BGM_EYE_BOY,
	[CLASS_SPECIES_RANGER] = BGM_EYE_BOY,
...
const u16 gClassBasedTrainerEncounterBGM[NUM_TRAINER_CLASSES] =
{
	...
	[CLASS_SPECIES_BREEDER] = BGM_EYE_AROMA_LADY_BEAUTY, //Just for F?
	[CLASS_SPECIES_RANGER] = BGM_EYE_ACE,
