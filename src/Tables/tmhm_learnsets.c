...
//#define TMHM_LEARNSET(moves) {(u32)(moves), ((u64)(moves) >> 32) | ( ((u32)(moves)), ((u64)(moves) >> 32)) >> 64}
#define TMHM(tmhm) ((u64)1 << (gItems[ITEM_##tmhm].secondaryId))
...
const u32 gTMHMLearnsets[][4] = {
	...
	[SPECIES_BASCULIN_RED]    = TMHM_LEARNSET(TMHM(TM45_ATTRACT)
											| TMHM(HM01_CUT)
											| TMHM(HM08_DIVE)
											| TMHM(TM32_DOUBLE_TEAM)
											| TMHM(TM42_FACADE)
	...
	[SPECIES_MINIOR_SHIELD]      = TMHM_LEARNSET(TMHM(TM45_ATTRACT)
											| TMHM(TM04_CALM_MIND)
											| TMHM(TM32_DOUBLE_TEAM)
											| TMHM(TM26_EARTHQUAKE)
											| TMHM(TM42_FACADE)
