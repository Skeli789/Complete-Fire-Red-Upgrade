	...
	[6] =
		{
			...
			.legendarySpreads = gSpecialTowerSpread_Paula1,
			.middleCupSpreads = gSpecialTowerSpread_Paula1,
			.littleCupSpreads = gSpecialTowerSpread_Paula1,
			.regSpreadSize = 	ARRAY_COUNT(gSpecialTowerSpread_Paula1),
			.mcSpreadSize =		ARRAY_COUNT(gSpecialTowerSpread_Paula1),
			.lcSpreadSize =		ARRAY_COUNT(gSpecialTowerSpread_Paula1),
			.legSpreadSize =	ARRAY_COUNT(gSpecialTowerSpread_Paula1),
		},
	[7] =
		{
			.owNum = 			EVENT_OBJ_GFX_PAULA,
			...
			.legendarySpreads = gSpecialTowerSpread_Paula2,
			.middleCupSpreads = gSpecialTowerSpread_Paula2,
			.littleCupSpreads = gSpecialTowerSpread_Paula2,
			.regSpreadSize = 	ARRAY_COUNT(gSpecialTowerSpread_Paula2),
			.mcSpreadSize =		ARRAY_COUNT(gSpecialTowerSpread_Paula2),
			.lcSpreadSize =		ARRAY_COUNT(gSpecialTowerSpread_Paula2),
			.legSpreadSize =	ARRAY_COUNT(gSpecialTowerSpread_Paula2),
		},
};
